 ...
 */
export async function updatePresenceFromRequest(event: RequestEvent, boardId: string): Promise<void> {
	try {
 ...
 */
export function getBoardIdFromParams(params: Record<string, string>): string | null {
 ...
 */
export async function refreshPresenceOnBoardAction(event: RequestEvent): Promise<void> {
