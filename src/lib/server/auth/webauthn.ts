...
export async function generatePasskeyRegistrationOptions(
	...
	console.log("generatePasskeyRegistrationOptions called with:", {
		userId,
		userName,
		userDisplayName,
	});
	...
	try {
		...
		console.log(
			"Found existing authenticators:",
			existingAuthenticators.length,
		);
		...
		console.log(
			"WebAuthn registration options generated, challenge:",
...
export async function verifyPasskeyRegistration(
	...
	try {
		...
		if (verification.verified && verification.registrationInfo) {
			...
			console.log(
				"Registration info credential.id:",
			...
			console.log(
				"Registration verification successful, authenticatorId:",
				authenticatorId,
			);
...
export async function generatePasskeyAuthenticationOptions(
	...
	console.log(
		"generatePasskeyAuthenticationOptions called with email:",
		userEmail || "none",
	);
	...
	console.log(
		"Generating authentication options with allowCredentials:",
		allowCredentials ? allowCredentials.length : "none",
	);
	...
	console.log(
		"Authentication options generated, challenge stored with key:",
		challengeKey,
	);
	return options;
}
...
export async function verifyPasskeyAuthentication(
	...
	try {
		...
		const allCreds = await db
			.select({ credentialId: userAuthenticators.credentialId })
			.from(userAuthenticators);
		console.log(
			"All credential IDs in database:",
			allCreds.map((c) => c.credentialId),
		);
		...
		console.log("Authenticator device prepared:", {
			...
			credentialPublicKey:
				authenticatorDevice.credentialPublicKey.length + " bytes",
 ...
 */
export async function deleteUserAuthenticator(
	userId: string,
