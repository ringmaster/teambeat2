...
export async function cloneBoard(boardId: string, name: string): Promise<{ boardId: string }> {
...
export async function createCard(boardId: string, columnId: string, content: string): Promise<any> {
	const response = await fetch(`/api/boards/${boardId}/cards`, {
		method: 'POST',
		headers: { 'Content-Type': 'application/json' },
...
export async function moveCard(cardId: string, columnId: string, sequence: number): Promise<void> {
...
export async function groupCardOnto(cardId: string, targetCardId: string): Promise<void> {
...
export async function groupCards(boardId: string, cardIds: string[], name: string): Promise<void> {
...
export async function voteCard(cardId: string, increment: number): Promise<VotingData> {
...
export async function fetchVotingStats(boardId: string): Promise<VotingStatsData> {
...
export async function changeScene(boardId: string, sceneId: string): Promise<any> {
...
export async function createColumn(boardId: string, name: string): Promise<any> {
...
export async function fetchColumnPresets(boardId: string): Promise<{ presets: any[] }> {
...
export async function updateColumnDisplay(
	...
	const response = await fetch(`/api/boards/${boardId}/scenes/${sceneId}/columns`, {
		method: 'PUT',
		headers: { 'Content-Type': 'application/json' },
...
export async function createScene(boardId: string, name: string, mode: string): Promise<any> {
	const response = await fetch(`/api/boards/${boardId}/scenes`, {
		method: 'POST',
		headers: { 'Content-Type': 'application/json' },
...
export async function startTimer(boardId: string, duration: number): Promise<void> {
...
export async function addTimerTime(boardId: string, additionalSeconds: number): Promise<void> {
	const response = await fetch(`/api/boards/${boardId}/timer`, {
		method: 'PATCH',
		headers: { 'Content-Type': 'application/json' },
...
export async function updatePresence(boardId: string, activity: string): Promise<void> {
...
export async function createComment(cardId: string, content: string): Promise<any> {
...
export async function fetchAgreements(boardId: string): Promise<AgreementsData> {
...
export async function fetchPresentModeData(boardId: string): Promise<PresentModeData> {
	const response = await fetch(`/api/boards/${boardId}/present-data`);
	if (!response.ok) {
		throw new Error(`Failed to fetch present mode data: ${response.statusText}`);
	}
	return await response.json();
}
