	...
	questions: [
		{
			...
			description:
				"Releasing is simple, safe, painless & mostly automated vs. risky, painful, lots of manual work",
			questionType: "redyellowgreen",
		},
		{
			question: "Suitable process",
			description:
				"Our way of working fits us perfectly vs. our way of working sucks",
			questionType: "redyellowgreen",
		},
		{
			question: "Tech quality (code base health)",
			description:
				"We're proud of the quality of our code vs. our code is a pile of dung",
			questionType: "redyellowgreen",
		},
		{
			question: "Value",
			description:
				"We deliver great stuff! We're proud of it vs. we deliver crap",
			questionType: "redyellowgreen",
		},
		{
			question: "Speed",
			description:
				"We get stuff done really quickly vs. we never seem to get done with anything",
			questionType: "redyellowgreen",
		},
		{
			question: "Mission",
			description:
				"We know exactly why we are here, and we are excited about it vs. our mission is unclear and uninspiring",
			questionType: "redyellowgreen",
		},
		{
			question: "Fun",
			description:
				"We love going to work, and have great fun working together vs. boring",
			questionType: "redyellowgreen",
		},
		{
			question: "Learning",
			description:
				"We're learning lots of interesting stuff all the time vs. we never have time to learn anything",
			questionType: "redyellowgreen",
		},
		{
			question: "Support",
			description:
				"We always get great support & help when we ask for it vs. we keep getting stuck because we can't get support",
			questionType: "redyellowgreen",
		},
		{
			question: "Pawns or players",
			description:
				"We are in control of our destiny vs. we are just pawns in a game of chess",
			questionType: "redyellowgreen",
		},
		{
			question: "Teamwork",
			description:
				"We are a great team working well together vs. we struggle to work as a team",
			questionType: "redyellowgreen",
		},
	],
};
	...
	questions: [
		{
			...
			description:
				"We have mutual trust and respect vs. we lack trust and connection",
			questionType: "redyellowgreen",
		},
		{
			question: "Balanced team",
			description:
				"We have the right people with the right skills in the right roles vs. we lack key skills or have unclear roles",
			questionType: "redyellowgreen",
		},
		{
			question: "Encouraging difference",
			description:
				"We seek and voice different viewpoints and work through differences respectfully vs. we avoid diverse perspectives",
			questionType: "redyellowgreen",
		},
		{
			question: "Shared understanding",
			description:
				"We share understanding of our mission, purpose, and milestones vs. our direction is unclear",
			questionType: "redyellowgreen",
		},
		{
			question: "Value and metrics",
			description:
				"We understand our value, how it's measured, and use metrics to make decisions vs. we lack clarity on value and success",
			questionType: "redyellowgreen",
		},
		{
			question: "Suitable ways of working",
			description:
				"Our ways of working enable us to do our jobs effectively vs. our processes hinder our work",
			questionType: "redyellowgreen",
		},
		{
			question: "Engagement and support",
			description:
				"It's clear how to engage with us and teams get the support they need vs. engagement with our team is unclear or ineffective",
			questionType: "redyellowgreen",
		},
		{
			question: "Continuous improvement",
			description:
				"We celebrate successes and act on improvement opportunities with regular feedback loops vs. we don't make time for reflection or improvement",
			questionType: "redyellowgreen",
		},
	],
};
