                ...
                <div class="config-header-content">
                    ...
                    <nav class="config-tabs">
                        <button
                            ...
                            class="config-tab {configActiveTab === 'columns' ? 'config-tab-active' : ''}"
                        >
                            Columns
                        </button>
                        <button
                            onclick={() => onTabChange("scenes")}
                            class="config-tab {configActiveTab === 'scenes' ? 'config-tab-active' : ''}"
                        >
                            Scenes
                        </button>
                        {#if ["admin", "facilitator"].includes(userRole)}
                            <button
                                ...
                                class="config-tab {configActiveTab === 'users' ? 'config-tab-active' : ''}"
                            >
                                Users
                            </button>
                        {/if}
                        <button
                            ...
                            class="config-tab {configActiveTab === 'general' ? 'config-tab-active' : ''}"
                        >
                            General
                        </button>
                    </nav>
