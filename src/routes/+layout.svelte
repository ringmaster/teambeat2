		...
		<div class="page-container">
			<div class="footer-content">
				<div class="footer-left">
					...
					<span class="footer-copyright">© {new Date().getFullYear()} TeamBeat. Built for better retrospectives.</span>
				</div>
