...
import { findUserById, ensureEmailVerificationSecret } from '$lib/server/repositories/user.js';
...
export const POST: RequestHandler = async (event) => {
	...
	const token = generateEmailVerificationToken(user.id, emailVerificationSecret);
