...
test.describe('Simple Authentication Tests', () => {
  ...
  test('should register a new user successfully', async ({ page }) => {
    ...
    await expect(page.locator('text=Test User').or(page.locator('.nav-brand-text'))).toBeVisible();
  });
  ...
  test('should show error for mismatched passwords during registration', async ({ page }) => {
    ...
    await expect(page.locator('.form-error')).toBeVisible();
    await expect(page.locator('text=Passwords do not match').or(page.locator('text=Password confirmation does not match'))).toBeVisible();
  });
